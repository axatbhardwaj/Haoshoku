...
- **Desktop/editor integration:** apply narrow approved entry removal, preserving general files and bindings. Use the Omarchy skill for live desktop customization. Recheck affected behavior; no desktop restart merely to simplify evidence collection.
